...
function execute_checkup ($errorinfo, $statement, $depth=null) {
	if ($errorinfo[0] == "0000"): if ($depth == "full"): echo "<p style='font-style: italic; color: olive;'>Success ".$statement.".</p>"; endif; return "success";
	else: echo "<p style='font-style: italic; color: crimson;'>Failure $statement: ".$errorinfo[2].".</p>"; return "failure"; endif; } ?>
